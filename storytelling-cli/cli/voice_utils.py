...
def choose_narrator_voice(
    ...
    Returns the selected voice, the candidate pool that was used when
    randomization is enabled (empty list if not), and a boolean indicating
    whether random selection was applied.
    """
